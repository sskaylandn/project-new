          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{ url('admin/aset-akuisisi') }}" class="menu-link">
                      <div data-i18n="Account">Daftar Pemegang Aset</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ url('admin/index-akuisisi') }}" class="menu-link">
                      <div data-i18n="Notifications">Riwayat</div>
                    </a>
                  </li>
                </ul>
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{ url('admin/index-fisik') }}" class="menu-link">
                      <div data-i18n="Notifications">Riwayat</div>
                    </a>
                  </li>
                </ul>
              ...
              <li class="menu-item">
                ...
                <ul class="menu-sub">
                  <li class="menu-item">
                    <a href="{{ url('admin/index-whitelist') }}" class="menu-link">
                      <div data-i18n="Notifications">Riwayat</div>
                    </a> 
                  </li>
                </ul>
